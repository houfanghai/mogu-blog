...
public class RabbitMqUtil {
    ...
    public void sendSimpleEmail(String email, String text) {
        String content =
                "<html>\r\n" +
                        ...
                        "<div class=\"container\">\r\n" +
                        "<div class=\"logo\">\r\n" +
                        "<img src=\"" +"http://4k048528c0.wicp.vip:14231/blog/admin/jpg/2021/8/14/favicon.ico"+ "\",height=\"100\" width=\"100\">\r\n" +
                        "</div>\r\n" +
                        "<div class=\"panel\" style=\"background-color: rgb(246, 244, 236);\">\r\n" +
                        "<div class=\"panel-header\" style=\"background-color: rgb(246, 244, 236);\">\r\n" +
                        PROJECT_NAME + "邮件提醒\r\n" +
    ...
    public void sendActivateEmail(User user, String token) {
        ...
        String logoBase64=encoder.encode(data).trim().replaceAll("\n","").replaceAll("\r","");
        log.info("base64="+logoBase64);
        String text =
                "<html>\r\n" +
                        " <head>\r\n" +
                        "  <title>" + PROJECT_NAME + "</title>\r\n" +
                        ...
                        "<div class=\"container\">\r\n" +
                        "<div class=\"logo\">\r\n" +
                        "<img src=\"data:image/png;base64," + logoBase64 + "\",height=\"100\" width=\"100\">\r\n" +
                        "</div>\r\n" +
                        "<div class=\"panel\" style=\"background-color: rgb(246, 244, 236);\">\r\n" +
                        "<div class=\"panel-header\" style=\"background-color: rgb(246, 244, 236);\">\r\n" +
                        PROJECT_NAME + "账号激活\r\n" +
